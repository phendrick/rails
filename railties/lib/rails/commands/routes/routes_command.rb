...
module Rails
  module Command
    class RoutesCommand < Base # :nodoc:
      ...
      class_option :compact, type: :boolean, aliases: "-C", desc: "Print a compact list of routes"
      ...
      private
        ...
        def formatter
          ...
          elsif options.key?("compact")
            ActionDispatch::Routing::ConsoleFormatter::Compact.new
          else
